...
::: {.notes}
In luce dei vari utilizzi delle SDR, questi sono gli obiettivi del progetto OpenRFSense: `...`
:::
...
- il linguaggio Go, creato appositamente da Google per sviluppo backend
