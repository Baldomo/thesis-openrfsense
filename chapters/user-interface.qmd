...
![Dashboard](/assets/dashboard){width=80%}
...
![Node overview page](/assets/node){width=80%}
...
![API documentation](/assets/api-docs){width=80%}
...
![Node system management page](/assets/node-ui.png){width=80%}
